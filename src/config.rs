...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("SoCoSys_Sentry".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["relay.socosystems.net"];
pub const RS_PUB_KEY: &str = "1WBZSNFpHBxvK+d8GmuhviCs1ZWcAePlonxlL+Ja1Fg=";
